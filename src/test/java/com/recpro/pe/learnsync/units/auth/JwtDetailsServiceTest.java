...
public class JwtDetailsServiceTest {
    ...
    void testLoadUserByUsername() {
        ...
        User user = new User(1, "jluyo", "jluyoc1@upao.edu.pe", "upao2025", true, false, null, 100, null, new ArrayList<>(), new ArrayList<>(), new Role(1, ERole.ADMIN, new ArrayList<>()), null, new ArrayList<>());
